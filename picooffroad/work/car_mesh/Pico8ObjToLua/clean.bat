...
del bin\*.ipdb
del bin\*.ilk
del bin\Pico8ObjToLua_d.exe
del bin\Pico8ObjToLua_x64_d.exe
...
attrib -H project\vs2013\Pico8ObjToLua.v12.suo
del project\vs2013\Pico8ObjToLua.v12.suo
...
attrib -H project\vs2015\Pico8ObjToLua.v12.suo
del project\vs2015\Pico8ObjToLua.v12.suo
